 ...
 * @property integer $cesantia_mercantil
...
class ValoresComisionBaseCargosBasicos extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('comision, cesantia_mercantil, activo', 'required'),
			array('cesantia_mercantil, activo', 'numerical', 'integerOnly'=>true),
			array('comision', 'length', 'max'=>8),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, comision, cesantia_mercantil, activo', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('cesantia_mercantil',$this->cesantia_mercantil);
