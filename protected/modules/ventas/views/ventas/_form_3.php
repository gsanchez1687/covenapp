        ...
        <section id="<?php echo $Ventas ?>">
            ...
            <div class="form-group">
                ...
                <div class="col-xs-12 col-sm-8">
                    ...
                    <div class="btn-group" >
                        <i id="preloader"></i>
                        <?php echo CHtml::link('<i class="fa fa-search" aria-hidden="true"></i> Buscar Cliente', '', array('onclick' => 'buscarCliente()', 'class' => 'btn btn-info btn-square')); ?>                                             
                        <?php $this->widget('booster.widgets.TbButton', array('label' => 'Nuevo Cliente', 'context' => 'primary', 'htmlOptions' => array('class' => 'btn btn-sucesses btn-square', 'data-toggle' => 'modal', 'data-target' => '#basicModal',),)); ?>
                    </div> 
        ...
        <section id="<?php echo $VentaMovile ?>">
            ...
            <div class="form-group">
                ...
                <div class="col-xs-12 col-sm-8">
                    ...
                    <input type="radio" id="radio4" name="VentasMoviles[origen_equipo]" value="0" checked="checked" /><label for="radio4">Traido</label>
