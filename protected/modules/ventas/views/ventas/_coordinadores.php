                    ...
                    <div class="table-responsive">      
                        <div id="altoanchopantalla">                       
                            ...
                            $this->widget('zii.widgets.grid.CGridView', array(
                                'id' => 'ventas-coordinador-grid',
                                'itemsCssClass' => 'table table-striped table-hover table-responsive scroll',
                                'dataProvider' => $modelMisVentasCoordinador->coordinadores(),
                                'filter' => $modelMisVentasCoordinador,
                                'columns' => array(
                                    /* venta */
                                    'id',
                                    array('name' => 'creado', 'header' => 'Fecha Ingreso', 'type' => 'raw', 'value' => 'date("d/m/y h:i A", strtotime($data->creado))', 'htmlOptions' => array('class' => 'width_fecha_ingreso'), 'filter' => $this->widget('zii.widgets.jui.CJuiDatePicker', array('model' => $modelMisVentasCoordinador, 'attribute' => 'creado'), true)),
