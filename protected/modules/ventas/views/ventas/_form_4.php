        ...
        <section id="<?php echo $Ventas ?>">
            ...
            <div class="form-group">
                ...
                <div class="col-xs-12 col-sm-8">
                    ...
                    <div style="background-color: #dfe6e9" id="CrearCliente">
...
//                                            'maxDate' => '2099-12-31', // Fecha maxima
                            ...
                            <div style="margin-left: 40px" class="btn-group  btn-block">                                
...
//                            'changeYear' => true,
            ...
            <div id="link_imagen">            
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-8">
                        <?php echo $this->widget('ext.counter.GTextfield', array('model' => $model, 'attribute' => 'link_imagen', 'allowed' => 100, 'htmlOptions' => array('placeholder' => '', 'class' => 'form-control'),), true); ?>
