...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'comprobantes_pagos_totalizadas_id'); ?>
		<?php echo $form->textField($model,'comprobantes_pagos_totalizadas_id'); ?>
		<?php echo $form->error($model,'comprobantes_pagos_totalizadas_id'); ?>
	</div>
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'liquidacion',array('size'=>60,'maxlength'=>100)); ?>
