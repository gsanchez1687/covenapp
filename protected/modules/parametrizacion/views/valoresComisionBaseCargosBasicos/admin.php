...
$('.search-form form').submit(function(){
	$('#valores-comision-base-cargos-basicos-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
    ...
    <div class="col-xs-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3>Parametrizacion ETB Fija</h3>                
                <center>
            ...
            <div class="panel-body">
                <div class="table-responsive">
                    ...
                    $this->widget('zii.widgets.grid.CGridView', array(
                        'id' => 'valores-comision-base-cargos-basicos-grid',
                        'itemsCssClass' => 'table table-hover table-stripped table-responsive',
                        'dataProvider' => $model->search(),
                        'filter' => $model,
                        'columns' => array(                                                     
                            array('name'=>'tipo_id','type'=>'raw','value'=>'$data->tipo->tipo'),
                            'comision',
                            'cesantia_mercantil',                            
                            array('name'=>'activo','type'=>'raw','value'=>'Controller::getActivos($data->activo)'),
                            array(
                                'class' => 'CLinkColumn',
