    ...
    <div class="col-xs-12">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h4 class="panel-title"><?php echo Yii::t('app', 'Items'); ?></h4>                
            </div>
            <br />
            <center>
                <div class="btn-group"  role="group" aria-label="...">                
                    ...
                    <?php echo CHtml::link('<i class="fa fa-plus" aria-hidden="true"></i>Nuevo Item', array('items/create'), array('class' => 'btn btn-info btn-square')); ?>                 
                </div>               
            </center>
                ...
                <div class="table-responsive">
                    ...
                    $this->widget('zii.widgets.grid.CGridView', array(
                        ...
                        'columns' => array(
                            'item',
                            'name',
                            array('name' => 'menu_id', 'value' => '$data->menu->name', 'type' => 'text', 'filter' => CHtml::listData(Menus::model()->findAll(), "id", "name")),
                            array('name' => 'active', 'type' => 'raw', 'value' => 'Items::checkSwicthLabel($data->active)'),
                            array(
                                'class' => 'CLinkColumn',
