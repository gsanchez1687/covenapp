...
class ItemsController extends Controller
{
	...
	{
             if (Yii::app()->authRBAC->checkAccess('roles_crear')):    
		$model=new Items;
	...
	{
            if (Yii::app()->authRBAC->checkAccess('roles_editar')):    
		$model=$this->loadModel($id);
	...
	{
             if (Yii::app()->authRBAC->checkAccess('roles_eliminar')):    
	...
	{
            if (Yii::app()->authRBAC->checkAccess('roles_menu_item')):    
