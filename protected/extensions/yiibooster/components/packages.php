...
return array(
	...
	'datepicker' => array(
		'depends' => array('jquery'),
		'baseUrl' => $this->enableCdn ? '//cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.7.1/' : $this->getAssetsUrl() . '/bootstrap-datepicker/',
		'css' => array('css/bootstrap-datepicker3.css'),  //$this->minify ? 'css/datepicker.min.css' : 'css/datepicker.css'),
