var YiiChat = function(options){
	...
	you.html("<textarea class='form-control'></textarea><div class='exceded'></div><br/>");	
	you.append("<button class='btn btn-primary btn-block btn-square'>"+options.sendButtonText+"</button>");
	posts.html("");
